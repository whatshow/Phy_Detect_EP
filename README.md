...
* Install through `Matlab Add-Ons`
    ...
    Go to [https://github.com/whatshow/Phy_Detect_EP/releases](https://github.com/whatshow/Phy_Detect_EP/releases) to download the file `Phy_Detect_EP.mltbx` in the latest release to install.<br>
